...
kia = SportCar(100, 'Red', 'KIA', False)
mini_cooper = TownCar(30, 'White', 'Mini Cooper', False)
lada = WorkCar(70, 'Black', 'Lada', False)
ford = PoliceCar(110, 'Blue', 'Ford', True)
print(kia.turn_right())
print(f'When {ford.turn_right( )}, then {kia.stop( )}')
print(f'{mini_cooper.go( )} with speed exactly {mini_cooper.show_speed( )}')
